...
describe('business overview', () => {
  it('aggregates revenue, costs, margin and collections for the selected period', () => {
    const data = {
      ...
      rail: [],
      coneHistory: [],
      plannerSettings: { operators: [], workingDays: [1, 2, 3, 4, 5], efficiencyPercent: 100, safetyMarginPercent: 10, holidays: [], closures: [], absences: [], monthlyRevenueGoal: 10000, monthlyMarginGoal: 3000 },
      plannerAssignments: [],
